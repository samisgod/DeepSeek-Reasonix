  ...
  return [
    {
      ...
      detail: "legacy delivery record; current runs let the model judge completion",
    ...
    notice(4, "info", "The same tool call has been requested several times.", "repeat reminder at count 3; the tool remains available", "loop_guard"),
    ...
    notice(9, "info", "A previous external call has an unknown result.", "inspect external state before repeating a side effect; tools remain available"),
