...
var providerCatalog = map[string]ProviderCatalog{
	...
	"commandcode-chat":      {BrandID: "commandcode", BrandLabel: "CommandCode", Region: "global", Product: "api"},
	"commandcode-anthropic": {BrandID: "commandcode", BrandLabel: "CommandCode", Region: "global", Product: "api"},
	"commandcode-responses": {BrandID: "commandcode", BrandLabel: "CommandCode", Region: "global", Product: "api"},
